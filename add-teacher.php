 ...
 <div class="app-title">
      ...
      <div class="row">
        ...
        <form method="POST" style="">
                <div class="col-lg-12">
                   <h1><i class="fa fa-user"></i> New Teacher</h1>
          <p>Teacher Registration</p><hr><p>

             <div class="btn-group" style="margin-bottom: 28px;">
                <a href="teachers.php" class="btn btn-info"><b class="fa fa-users"></b> All Teachers</a>

                <a href="add-teacher.php" class="btn btn-primary"><b class="fa fa-user"></b> <b class="fa fa-plus"></b> New Teacher</a>
              </div>
                     ...
                     <div class="col-md-6">
                                ...
                                <div class="form-group" id="stu">
                                    <div class="input-group">
                                        ...
                                        <select  class="form-control" required="required" name="class" style="display: none;">
